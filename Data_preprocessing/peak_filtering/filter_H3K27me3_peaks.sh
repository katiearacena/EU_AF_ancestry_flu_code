...
cat ../../H3K27me3_peaks/*.bed | sed -e 's/peak_call\///' -e 's/_H3K27me3.*//' | sort -k1,1 -k2,2n | 
...
bedtools intersect -a - -b $blacklist -v -sorted > $OUT_DIR/H3K27me3_peaks_filtered.bed

#Final check!

cat $OUT_DIR/H3K27me3_peaks_filtered.bed | awk '{if($5 <= 13) print }'
