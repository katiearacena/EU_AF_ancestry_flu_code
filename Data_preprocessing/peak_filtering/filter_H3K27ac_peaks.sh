...
cat ../../H3K27ac_peaks/*.bed | sed -e 's/peak_call\///' -e 's/_H3K27ac.*//' | sort -k1,1 -k2,2n | 
...
bedtools intersect -a - -b $blacklist -v -sorted > $OUT_DIR/H3K27ac_peaks_filtered.bed

#Final check!

cat $OUT_DIR/H3K27ac_peaks_filtered.bed | awk '{if($5 <= 14) print }'
