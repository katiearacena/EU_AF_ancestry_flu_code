...
system(paste0("mkdir -p Outputs/",folder,"/STR-QTL_mapping/", data, "/", condition, "/", res_dir, "_", expPCs_reg, "/"))
out_dir <- paste0("Outputs/",folder,"/STR-QTL_mapping/", data, "/", condition, "/", res_dir,  "_", expPCs_reg, "/")
