...
qqplot(-log10(permuted1_best_EQTL[,4]), -log10(results_best_SNPs_with_qval[,4]), ylim=  c(0, 40), xlim= c(0, 40), main ="Best STRs qqplot", xlab = "-log10(theoretical p-values)", ylab = "-log10(observed p-values)")
