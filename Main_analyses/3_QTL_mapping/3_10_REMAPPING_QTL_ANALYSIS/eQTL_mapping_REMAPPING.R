...
system(paste0("mkdir -p Outputs/",folder,"/SNP-QTL_mapping-REMAPPED_cts/", data, "/", condition, "/", res_dir, "/"))
out_dir <- paste0("Outputs/",folder,"/SNP-QTL_mapping-REMAPPED_cts/", data, "/", condition, "/", res_dir, "/")
...
reads_whole = read.table(paste0("Outputs/2_ancestry_effects_modeling/batch_corrected_cts_matrices/",data, "_batch.age.corrected.REMAPPED.txt"), header=TRUE, row.names=1)
