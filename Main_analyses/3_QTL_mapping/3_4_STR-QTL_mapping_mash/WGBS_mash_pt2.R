...
system(paste0("mkdir -p Outputs/",folder,"/STR-QTL_mash/", data, "/part", part, "_outputs/"))
out_dir <- paste0("Outputs/",folder,"/STR-QTL_mash/", data, "/part", part, "_outputs/")


load(paste0("Outputs/",folder,"/STR-QTL_mash/WGBS/mash_random.Rdata"))
x <- load(paste0("Outputs/",folder,"/STR-QTL_mash/WGBS/data_STRONG_p", part, ".Rdata"))
data_STRONG = get(x)
