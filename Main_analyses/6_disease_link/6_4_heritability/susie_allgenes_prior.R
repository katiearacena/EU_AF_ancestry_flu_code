...
# ## Example settings
# phenotype_name <- "ATACseq_Flu"
# L <- 3
# susie_prior <- "dist"
# torus_dir <- "/scratch/midway2/kaixuan/flu_regulatoryQTLs/torus/ATACseq_Flu"
# susie_input_dir <- "/scratch/midway2/kaixuan/flu_regulatoryQTLs/susie/input/ATACseq_Flu"
# outdir <- "/project2/xinhe/kevinluo/flu_regulatoryQTLs/susie/output/ATACseq_Flu"
# num_cores <- 10
  ...
  susie_allgenes_res <- foreach( iGene=genes_to_finemap ) %dopar% {
    ...
    if(is.null(data)){
      ...
      if(susie_prior == "dist"){
        ...
        # prior <- read.table(paste0(torus_dir, "/", phenotype_name, ".dist.prior/", iGene, ".prior"))
